<!-- ============================================================= FOOTER ============================================================= -->
                                    ...
                                    <ul>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/blank.gif" data-echo="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-small-01.jpg" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/blank.gif" data-echo="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-small-02.jpg" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/blank.gif" data-echo="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-small-03.jpg" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/blank.gif" data-echo="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-small-04.jpg" />
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/blank.gif" data-echo="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-small-05.jpg" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/blank.gif" data-echo="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-small-06.jpg" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/blank.gif" data-echo="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-small-07.jpg" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/blank.gif" data-echo="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-small-08.jpg" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/blank.gif" data-echo="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-small-09.jpg" />
                                                    </a>
                                                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="col-xs-12 col-sm-6 no-margin">
                            <div class="payment-methods ">
                                <ul>
                                    <li><img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/payments/payment-visa.png"></li>
                                    <li><img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/payments/payment-master.png"></li>
                                    <li><img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/payments/payment-paypal.png"></li>
                                    <li><img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/payments/payment-skrill.png"></li>
                                </ul>
                            </div><!-- /.payment-methods -->
                        </div>
                    </div><!-- /.container -->
		...
		<script src="<?php echo get_template_directory_uri(); ?>/assets/js/css_browser_selector.min.js"></script>
	    ...
	    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery.raty.min.js"></script>
	    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery.prettyPhoto.min.js"></script>
	    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery.customSelect.min.js"></script>
	    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/wow.min.js"></script>
		<script src="<?php echo get_template_directory_uri(); ?>/assets/js/buttons.js"></script>

		<!-- For demo purposes – can be removed on production -->
		<script src="<?php echo get_template_directory_uri(); ?>/switchstylesheet/switchstylesheet.js"></script>
        <script src="<?php echo get_template_directory_uri(); ?>/js/scripts.js" type='module'></script>
...
<!-- Mirrored from transvelo.github.io/mediacenter-html/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jun 2020 11:08:25 GMT -->
</html>
