...
<!-- Mirrored from transvelo.github.io/mediacenter-html/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jun 2020 11:08:22 GMT -->
...
<head>
	    ...
	    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/colors/green.css">
		...
		<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/config.css">

		<link href="<?php echo get_template_directory_uri(); ?>/assets/css/colors/green.css" rel="alternate stylesheet" title="Green color">
		<link href="<?php echo get_template_directory_uri(); ?>/assets/css/colors/blue.css" rel="alternate stylesheet" title="Blue color">
		<link href="<?php echo get_template_directory_uri(); ?>/assets/css/colors/red.css" rel="alternate stylesheet" title="Red color">
		<link href="<?php echo get_template_directory_uri(); ?>/assets/css/colors/orange.css" rel="alternate stylesheet" title="Orange color">
		<link href="<?php echo get_template_directory_uri(); ?>/assets/css/colors/navy.css" rel="alternate stylesheet" title="Navy color">
		<link href="<?php echo get_template_directory_uri(); ?>/assets/css/colors/dark-green.css" rel="alternate stylesheet" title="Darkgreen color">
						                    ...
						                    <div class="basket-item">
						                        <div class="row">
						                            <div class="col-xs-4 col-sm-4 no-margin text-center">
						                                <div class="thumb">
						                                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-small-01.jpg" />
						                                </div>
						                            </div>
                            ...
                            <ul class="inline">
                                <li class="dropdown le-dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <i class="fa fa-list"></i> Post Categorys
                                    </a>
                                    <ul class="dropdown-menu">
                                    ...
                                    <ul>
                                        ...
                                        <?php if(!is_front_page()): ?>
                                            <li class="breadcrumb-item current gray">
                                                <a href="<?php the_permalink(); ?>"><?php wp_title( '', true, '' ); ?></a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
